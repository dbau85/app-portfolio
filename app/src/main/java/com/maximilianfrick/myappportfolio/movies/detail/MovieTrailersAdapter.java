...
public class MovieTrailersAdapter extends RecyclerView.Adapter<MovieTrailersAdapter.ViewHolder> {
    ...
    public MovieTrailersAdapter(MoviesDetailView.OnTrailerClickListener listener) {
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        void updateView(int position) {
            txtType.setText(trailers.get(position).getType());
            txtTrailer.setText(trailers.get(position).getName());
        }
    }
}
