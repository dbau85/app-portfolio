...
public class ReviewsExpListViewAdapter extends BaseExpandableListAdapter {
   ...
   public View getGroupView(int groupPosition, boolean isExpanded, View convertView,
      ...
      if (convertView == null) {
         convertView = LayoutInflater.from(parent.getContext())
               .inflate(R.layout.item_exp_list_group, parent, false);
      }
      TextView title = (TextView) convertView.findViewById(R.id.exp_list_title);
      title.setText(reviews.get(groupPosition)
            .getAuthor());
      return convertView;
   }
   ...
   public View getChildView(int groupPosition, int childPosition, boolean isLastChild,
      ...
      if (convertView == null) {
         convertView = LayoutInflater.from(parent.getContext())
               .inflate(R.layout.item_exp_list_item, parent, false);
      }
      TextView content = (TextView) convertView.findViewById(R.id.exp_list_item);
      content.setText(reviews.get(groupPosition)
            .getContent());
      return convertView;
   }
